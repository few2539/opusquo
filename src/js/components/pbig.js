window.js_shuffle = {
    ...
    initGrid: function () {
        ...
        if($(js_shuffle.containerSelector).length){
            var element = $(js_shuffle.containerSelector)[0];
            var sizer = $(js_shuffle.itemSelector)[0];
