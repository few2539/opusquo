...
class APIHelper
{
    ...
    public static function getCurrentFriendlyUrl()
    {
        ...
        if (is_null($path)) {
            $path = config('cms.homepage_path');
        }

        //Remove initial slashes
        return preg_replace('/(\/+)$/i', '/', config('cms.friendly_url_prefix')) .  preg_replace('/^(\/+)/i', '', $path);
    }
    ...
    public static function getSiteByDomainName($domainName = null)
    {
        ...
        $url = config('cms.api.urls.helpers.get_site');
    ...
    public static function getRedirectUrlBySourceUrl($sourceUrl, $domainName = null)
    {
        $data = null;
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.post_get_redirect_url');
        $applicationName = config('cms.application_name');
...
//        } catch (\Exception $e) {}
    ...
    public static function getPageData($friendlyUrl = null, $languageCode = null, $filterItems = [])
    {
        ...
        if (empty($friendlyUrl) || $friendlyUrl === $languageCode) {
            $friendlyUrl = config('cms.homepage_path');
        }
        ...
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.post_get_page');
        $applicationName = config('cms.application_name');
...
//        } catch (\Exception $e) {}
    ...
    public static function getParentPagesData(
        ...
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.post_get_parent_pages_data');
        $applicationName = config('cms.application_name');
    ...
    public static function getChildPagesData(
        ...
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.post_get_child_pages_data');
        $applicationName = config('cms.application_name');
    ...
    public static function getGlobalItemData($languageCode = null)
    {
        ...
        $data = null;
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.get_global_items');
        $applicationName = config('cms.application_name');
    ...
    public static function getSiteMapData($exceptions = [])
    {
        ...
        $data = null;
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.get_site_map_data');
        $applicationName = config('cms.application_name');
    ...
    public static function getSiteMapXML($languageCode = null)
    {
        ...
        $data = null;
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.get_site_map_xml');
        $applicationName = config('cms.application_name');
    ...
    public static function getFormPropertyData($variableName, $languageCode = null)
    {
        ...
        $data = null;
        $client = resolve(CMSConstants::CMS_API);
        $url = config('cms.api.urls.helpers.get_form_property_data');
        $token = config('cms.api.form_token');
        $applicationName = config('cms.application_name');
